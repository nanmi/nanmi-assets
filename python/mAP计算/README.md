...
link:https://github.com/Cartucho/mAP.git
...
把标记好的真正标签.txt放在`mAP/input/ground-truth/`

检测结果的.txt放在`mAP/input/detection-results`

如果想生成动画需要将检测的图片全部放在`mAP/input/images-optional`
